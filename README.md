...
- [Proposed CARPS Core Rules](#proposed-carps-core-rules)
  * [Tables](#tables)
    ...
    + [Table 1-2: Revised Craps Names](#table-1-2--revised-craps-names)
    + [Table 2-1: Craps Odds](#table-2-1--craps-odds)
    + [Table 2-2: Additional Odds](#table-2-2--additional-odds)
    + [Table 2-3: Critical](#table-2-3--critical)
  * [Aptitudes](#aptitudes)
    + [Table 3-1: Aptitude Scores](#table-3-1--aptitude-scores)
  * [Tasks & Actions (a.k.a Doing Things)](#tasks---actions--aka-doing-things-)
    + [Table 3-2: Difficulty](#table-3-2--difficulty)
  * [Episodes & Scenes](#episodes---scenes)
    + [Time](#time)
    + [Health](#health)
    + [Stress](#stress)
  * [Characters](#characters)
    ...
    + [Items](#items)
      - [4-1: Significant Items, Major](#4-1--significant-items--major)
      - [4-2: Significant Items, Minor](#4-2--significant-items--minor)
...
## Premise
With accessibility in mind; could a narrative-focused RPG be created using the established odds of street craps (results of 2d6 summed) & mixed interpretation of those results, while staying simple to read, understand, & run?
